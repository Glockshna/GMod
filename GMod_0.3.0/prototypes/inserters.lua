...
handOpenExtraLong 	= 	spritePath .. "/arms/hand-open-extralong.png"			--Orange
...
handClosedExtraLong	=	spritePath .. "/arms/hand-closed-extralong.png"		--Orange
...
data:extend(
	{	--Very Fast Inserters
		...
		--Filter Right
		{
			...
			icon = iconPath .. "/filter-right-veryfast.png",
			flags = {"goes-to-quickbar"},
			subgroup = "gm-right-inserters",
			order = "a",
		...
		{
			type = "item",
			name = "gm-very-fast-extra-long-inserter",
			icon = iconPath .. "/extralong-veryfast.png",
			flags = {"goes-to-quickbar"},
			subgroup = "gm-extra-long-inserters",
			order = "a",
			place_result = "gm-very-fast-extra-long-inserter",
			stack_size = 50
		},
		{
			type = "inserter",
			...
			icon = iconPath .. "/extralong-veryfast.png",
			flags = {"placeable-neutral", "placeable-player", "player-creation"},
			minable = {hardness = 0.2, mining_time = 0.5, result = "gm-very-fast-extra-long-inserter"},
			max_health = 40,
			corpse = "small-remnants",
			resistances =
			{
...
data:extend(
	{ 	--Motorized Inserters
		...
		{
			type = "item",
			name = "gm-motorized-extra-long-inserter",
			icon = iconPath .. "/extralong-motorized.png",
			flags = {"goes-to-quickbar"},
			subgroup = "gm-extra-long-inserters",
			order = "b",
			place_result = "gm-motorized-extra-long-inserter",
			stack_size = 50
		},
		{
			type = "inserter",
			...
			icon = iconPath .. "/extralong-motorized.png",
			flags = {"placeable-neutral", "placeable-player", "player-creation"},
			minable = {hardness = 0.2, mining_time = 0.5, result = "gm-motorized-extra-long-inserter"},
			max_health = 40,
			corpse = "small-remnants",
			resistances =
			{
...
data:extend(
	{	--Electric Inserters
		...
		{
			type = "item",
			name = "gm-electric-extra-long-inserter",
			icon = iconPath .. "/extralong-electric.png",
			flags = {"goes-to-quickbar"},
			subgroup = "gm-extra-long-inserters",
			order = "c",
			place_result = "gm-electric-extra-long-inserter",
			stack_size = 50
		},
		{
			type = "inserter",
			...
			icon = iconPath .. "/extralong-electric.png",
			flags = {"placeable-neutral", "placeable-player", "player-creation"},
			minable = {hardness = 0.2, mining_time = 0.5, result = "gm-electric-extra-long-inserter"},
			max_health = 40,
			corpse = "small-remnants",
			resistances =
			{
